...
describe('Statistics', () => {
  ...
  test('url', () => {
    ...
    expect(Statistics.url('2020-02', 'gen8ou')).toBe(
      'https://www.smogon.com/stats/2020-02/chaos/gen8ou-1825.json'
    );
    expect(Statistics.url('2020-02', 'gen6uu')).toBe(
      'https://www.smogon.com/stats/2020-02/chaos/gen6uu-1760.json'
    );
    ...
    expect(Statistics.url('2015-05', 'smogondoublessuspecttest')).toBe(
      'https://www.smogon.com/stats/2015-05/chaos/smogondoublessuspecttest-1760.json'
    );
    expect(Statistics.url('2015-04', 'smogondoublessuspecttest')).toBe(
      'https://www.smogon.com/stats/2015-04/chaos/smogondoublessuspecttest-1825.json'
    );

    // randombattle
    expect(Statistics.url('2017-01', 'randombattle')).toBe(
      'https://www.smogon.com/stats/2017-01/chaos/gen6randombattle-1760.json'
    );
    expect(Statistics.url('2016-12', 'gen6randombattle')).toBe(
      'https://www.smogon.com/stats/2016-12/chaos/gen6randombattle-1760.json'
    );
    expect(Statistics.url('2016-12', 'randombattle')).toBe(
      'https://www.smogon.com/stats/2016-12/chaos/randombattle-1825.json'
    );
    expect(Statistics.url('2016-11', 'gen6randombattle')).toBe(
      'https://www.smogon.com/stats/2016-11/chaos/randombattle-1825.json'
    );

    // general gen6
    expect(Statistics.url('2017-06', 'gen6uu')).toBe(
      'https://www.smogon.com/stats/2017-06/chaos/uu-1760.json'
    );
    expect(Statistics.url('2017-07', 'uu')).toBe(
      'https://www.smogon.com/stats/2017-07/chaos/gen6uu-1760.json'
    );

    // late gen6
    expect(Statistics.url('2017-06', 'gen6monotype')).toBe(
      'https://www.smogon.com/stats/2017-06/chaos/monotype-1760.json'
    );
    expect(Statistics.url('2017-07', 'monotype')).toBe(
      'https://www.smogon.com/stats/2017-07/chaos/monotype-1760.json'
    );
    expect(Statistics.url('2018-01', 'monotype')).toBe(
      'https://www.smogon.com/stats/2018-01/chaos/gen6monotype-1760.json'
    );

    // legacy
    expect(Statistics.url('2014-12', 'battleofhoeen')).toBe(
      'https://www.smogon.com/stats/2014-12/chaos/battleofhoeen-1760.json'
    );
    expect(Statistics.url('2020-02', 'gen6battleofhoeen')).toBe(
      'https://www.smogon.com/stats/2020-02/chaos/battleofhoeen-1760.json'
    );
    expect(Statistics.url('2020-02', 'battleofhoeen')).toBe(
      'https://www.smogon.com/stats/2020-02/chaos/gen6battleofhoeen-1760.json'
    );
  });
